...
namespace Raven {
	...
	/// <summary>
	/// Light interface, all light source must inherit this abstruct class
	/// </summary>
	class Light {
	public:
		...
		virtual Vector3f sample_Li(const SurfaceInteraction& inter, const Point2f& uv, Vector3f* wi, double* pdf, VisibilityTester* vTester)const = 0;
