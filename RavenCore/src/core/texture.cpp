...
//		return std::make_shared<ScaleTexture<double>>(t1.getRef(),
//t2.getRef());
//	}

//	Ref<Texture<Spectrum>> makeScaleTextureSpectrum(const PropertyList&
//param) { 		ObjectRef t1 = param.getObjectRef(0); 		ObjectRef t2 =
//param.getObjectRef(1);

//		return std::make_shared<ScaleTexture<Spectrum>>(t1.getRef(),
//t2.getRef());
//	}
//}
