...
class Material : public RavenObject {
 public:
  virtual void computeScarttingFunctions(SurfaceInteraction& its,
...
//	using MaterialConstructor = std::function<Ref<Material>(const
// PropertyList&)>; public: 	static std::map<std::string,MaterialConstructor>
// };
}  // namespace Raven
#endif