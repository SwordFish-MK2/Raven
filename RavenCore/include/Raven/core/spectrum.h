...
// convertion to RGB spectrum based on standard set defined on high-definition
// teltvision
...
public:
  ...
  RGBSpectrum(const RGBSpectrum &s, RGBType type = RGBReflection) { *this = s; }
...
// std::shared_ptr<double[]> v, int* n, const std::string& str);
